...
(function(root, factory) {
  ...
  describe('DetailedGear', function() {
    it('should create an instance of DetailedGear', function() {
      // uncomment below and update the code to test DetailedGear
      //var instance = new StravaApiV3.DetailedGear();
    ...
    it('should have the property frameType (base name: "frame_type")', function() {
      // uncomment below and update the code to test the property frameType
      //var instance = new StravaApiV3.DetailedGear();
      //expect(instance).to.be();
    });
