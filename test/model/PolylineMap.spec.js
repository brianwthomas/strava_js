...
(function(root, factory) {
  ...
  describe('PolylineMap', function() {
    it('should create an instance of PolylineMap', function() {
      // uncomment below and update the code to test PolylineMap
      //var instance = new StravaApiV3.PolylineMap();
    ...
    it('should have the property summaryPolyline (base name: "summary_polyline")', function() {
      // uncomment below and update the code to test the property summaryPolyline
      //var instance = new StravaApiV3.PolylineMap();
      //expect(instance).to.be();
    });
